...
abstract class CurlX
{
    ...
    /**
     * Send a PATCH request method with custom put data, headers, cookies and server tunnel
     *
     * @access public
     * @param string $url
     * @param string|array $data
    ...
    /**
     * Send a PUT request method with custom put data, headers, cookies and server tunnel
     *
     * @access public
     * @param string $url
     * @param string|array $data
     ...
     * @return object
     */
    public static function Put(string $url, $data = NULL, array $headers = NULL, string $cookie = NULL, array $server = NULL) : object
    {
        self::Prepare( $url );
        self::SetOpt( [
            CURLOPT_USERAGENT     => self::userAgent(),
    ...
    /**
     * Send a DELETE request method with custom delete data, headers, cookies and server tunnel
     *
     * @access public
     * @param string $url
     * @param string|array $data
     ...
     * @return object
     */
    public static function Delete(string $url, $data = NULL, array $headers = NULL, string $cookie = NULL, array $server = NULL) : object
    {
        self::Prepare( $url );
        self::SetOpt( [
            CURLOPT_USERAGENT     => self::userAgent(),
